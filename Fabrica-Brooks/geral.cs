...
namespace LibSILC
{
    public class geral
    {
        ...
        public static string NomeClienteFantasia = "";
        public static int CodigoCaminhao = 0;
        public static int CodigoMotorista = 0;
        public static int CodigoEmpresa = 0;
        public static int CodigoResiduo = 0;
        public static int CodigoDESTINOFINAL = 0;
        public static int NumeroNF = 0;
        public static string Ordem = string.Empty;
        public static bool Demonstracao = false;
        public static string cnpj_cpf = "";
        public static string senhamtre = "";
        public static string DataProgramada = "";
        public static bool NotaFiscalEnviada = false;

        private static bool _AcessoPrincipal = false;
        public static bool AcessoPrincipal
        {
            get { return geral._AcessoPrincipal; }
            set { geral._AcessoPrincipal = value; }
        }
        private static string _usuarioAtual;
        private static int _codigoUsuarioAtual;

        public static string UsuarioAtual
        {
            get { return geral._usuarioAtual; }
            set { geral._usuarioAtual = value; }
        }
        public static int CodigoUsuarioAtual
        {
            get { return _codigoUsuarioAtual; }
            set { _codigoUsuarioAtual = value; }
        }
        public static bool AcessoPermitido = false;    
        public static string VoltaForm = "";
        public static clsParametros oEmpresa = new clsParametros();
        public static clsParametrosDados oEmpresaDados = new clsParametrosDados();
