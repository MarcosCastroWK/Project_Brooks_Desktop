<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="programacaoInsercao.aspx.cs" Inherits="SILC.Web.forms.programacao_insercao" %>
                ...
                <tr>
                    <td>
                        <table style="word-spacing: 0; padding: 0; border: 0;">
                            <tr>
                                <td>
                                    <asp:Label ID="lblTitulo" runat="server" Text="Inser��o a partir do comercial" Font-Bold="True" Font-Names="Arial" CssClass="titulo2"></asp:Label>
                                </td>
                ...
                <tr>
                    <td>
                        <table>
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="Label1" runat="server" CssClass="LetrasLabel" Text="Res�duo"></asp:Label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="lblServicoExecutar" runat="server" CssClass="LetrasLabel" Text="Servi�o a Executar"></asp:Label>
                                </td>
                                <td colspan="3">
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="lblObservacao" runat="server" CssClass="LetrasLabel" Text="Observa��o"></asp:Label>
                                </td>
                                <td colspan="3">
                            ...
                            <tr>
                                <td>
                                    <table style="word-spacing: 0; padding: 0; border: 0;">
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="lblTitulo0" runat="server" Text="Servi�os Programados" Font-Bold="True" Font-Names="Arial" CssClass="titulo2"></asp:Label>
                                            </td>
                                            <td>&nbsp;</td>
                                        </tr>
                                    </table>
                                    ...
                                    <div id="Div1" style="width:100%;height:380px; overflow-y:scroll;border:ridge 5px;font-size:10pt;">
                                        <asp:GridView ID="Grade2" runat="server" CellPadding="3" Width="2000px" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" Font-Names="verdana" Font-Size="9px" ClientIDMode="AutoID" AutoGenerateColumns="False" ForeColor="Black" GridLines="Vertical" Font-Bold="False" PageSize="5" OnRowCommand="Grade2_RowCommand" OnRowDataBound="Grade2_RowDataBound" >
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="CodigoCliente" HeaderText="C�digo Cliente" SortExpression="CodigoCliente" >
                                                ...
                                                <asp:BoundField DataField="ExecutarServico" HeaderText="Executar Servi�o" SortExpression="ExecutarServico" />
                                                ...
                                                <asp:BoundField DataField="HoraProgramada" HeaderText="Servi�o Executado" SortExpression="HoraProgramada" />
                                                <asp:BoundField DataField="Quantidade" HeaderText="Quantidade" SortExpression="Quantidade" />
                                                <asp:BoundField DataField="CodigoCaminhao" HeaderText="C�digo Caminhao" SortExpression="CodigoCaminhao" />
                                                <asp:BoundField DataField="ModeloCaminhao" HeaderText="Caminh�o" SortExpression="ModeloCaminhao" />
                                                <asp:BoundField DataField="CodigoMotorista" HeaderText="C�digo Motorista" SortExpression="CodigoMotorista" />
                                                ...
                                                <asp:BoundField DataField="TipoProgramacao" HeaderText="Tipo Programa��o" SortExpression="TipoProgramacao" />
