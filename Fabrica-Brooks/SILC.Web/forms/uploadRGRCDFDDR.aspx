<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="uploadRGRCDFDDR.aspx.cs" Inherits="SILC.Web.forms.uploadRGRCDFDDR" %>
...
<script>
    ...
    {
        window.open('PesquisaClientes.aspx', '_blank', 'scrollbars=yes,status=yes,menubar=no,toolbar=no,resizable=no,z-lock=yes,width=1100px,top=0,left=0,height=550px');
                        ...
                        <div id="contentTopRightDiv" style="width:98%; overflow-y:scroll;border:ridge 5px;font-size:10pt;" >
                            <asp:GridView ID="Grade" runat="server" CellPadding="3" Width="80%" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" Font-Names="verdana" Font-Size="9px" ClientIDMode="AutoID" OnRowCommand="Grade_RowCommand" AutoGenerateColumns="False" OnRowDataBound="Grade_RowDataBound" ForeColor="Black" GridLines="Vertical" AllowSorting="True" OnSorting="Grade_Sorting" Font-Bold="False" AllowPaging="True" PageSize="6" >
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Id" HeaderText="Sequencial" SortExpression="Id">
                        ...
                        <table style="width:300px">
                            <tr>
                                <td class="auto-style10">
                                    <asp:Label CssClass="LetrasLabel" ID="lblCodigoCliente" runat="server" Font-Bold="False" Width="100px">&nbsp;Código cliente</asp:Label>
                                </td>
                                <td colspan="3">
                                    <table>
                                        <tr>
                                            <td>
                                                ...
                                                <asp:TextBox ID="txtNomeFantasia" runat="server" TabIndex="1" Width="221px" Enabled="False"></asp:TextBox>
                                            </td>
                                            <td>
                                                <asp:Button ID="btnProcura" runat="server" OnClick="btnProcura_Click" Text="Ok" Height="20px" />
                                            </td>
                                            <td>
                                                <img id="Img1" style="cursor:pointer;" src="../Images/procura2.png" onclick="AbrePesquisaClientes();" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="LetrasTD">
                                    <asp:TextBox ID="txtPeriodo" runat="server" TabIndex="1" Width="300px"></asp:TextBox>
                                </td>
                                <td class="LetrasTD">
                            ...
                            <tr>
                                ...
                                <td class="auto-style13"><asp:Button ID="btnProcurar" runat="server" OnClick="btnProcurar_Click" BorderWidth="0px" EnableTheming="False" ForeColor="InactiveBorder" Width="16px" />
                                    </td>
                            </tr>
                        </table>
                    </td>
