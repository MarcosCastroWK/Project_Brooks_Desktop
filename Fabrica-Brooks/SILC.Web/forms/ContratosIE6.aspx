<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContratosIE6.aspx.cs" Inherits="SILC.Web.forms.ContratosIE6" %>
...
<script>
    function AbrePesquisaClientes() {
        window.location = '../forms/PesquisaClientesIE6.aspx';
                                ...
                                <td colspan="6">
                                    <table>
                                        <tr>
                                            ...
                                            <td>                                    
                                                <asp:TextBox ID="txtCNPJ_CPF" runat="server" Enabled="False" onfocus="LimpaErro()" Width="140px"></asp:TextBox>
                                            </td>
                                            <td>
                                ...
                                <td colspan="6">
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtNome" onfocus="LimpaErro()" runat="server" Width="300px" Enabled="False"></asp:TextBox>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblNomeFantasia" CssClass="LetrasLabel" runat="server" Width="80px" Font-Bold="False" >&nbsp;Nome Fantasia</asp:Label>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtNomeFantasia" onfocus="LimpaErro()" runat="server" Width="300px" Enabled="False"></asp:TextBox>
                                            </td>
                                            <td>
                                                <asp:Label CssClass="LetrasLabel" ID="Label1" runat="server" Font-Bold="False">&nbsp;Observação</asp:Label>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtObservacao" onfocus="LimpaErro()" runat="server" TextMode="SingleLine" Width="300px" ></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td colspan="6">
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="Label10" CssClass="LetrasLabel" runat="server" Width="71px" Font-Bold="False">&nbsp;Data Registro</asp:Label>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtMotivoRecisao" onfocus="LimpaErro()" runat="server" TextMode="SingleLine" Width="200px"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td colspan="6">
                                   <table>
                                       <tr>
                                            ...
                                            <td>
                                                <uc1:INTEIRO7 runat="server" ID="intNumeroContrato" IndiceTab="0" />
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtAniversarioReajuste" onfocus="LimpaErro()" runat="server" TextMode="SingleLine" Width="60px" ></asp:TextBox>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtIndiceReajuste" onfocus="LimpaErro()" runat="server" TextMode="SingleLine" Width="60px" ></asp:TextBox>
                                            </td>
                                            <td>
                                                <asp:Label ID="lbl3" CssClass="LetrasLabel" runat="server" Width="77px" Font-Bold="False" >Caixas Locadas</asp:Label>
                                            </td>
                                            <td>
                                                <uc4:INTEIRO7 ID="intCaixasLocadas" runat="server" IndiceTab="0" />
                                            </td>
                                        </tr>
                                   </table>
                                </td>
                                ...
                                <td colspan="6">
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                 <uc1:INTEIRO7 runat="server" ID="intDiaVencimento" IndiceTab="0" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
