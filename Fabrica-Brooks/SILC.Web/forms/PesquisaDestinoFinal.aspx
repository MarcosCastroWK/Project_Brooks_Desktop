<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PesquisaDestinoFinal.aspx.cs" Inherits="SILC.Web.forms.webPesquisaDestinoFinal" %>
            ...
            <table class="form2">
                ...
                <tr>
                    <td id="dadosCab" valign="top" style="height:1%; font-size:9pt;">
                        <asp:Label ID="lblTitulo" runat="server" Text="&nbsp;Consulta&nbsp;Destino&nbsp;Final" CssClass="titulo2" Font-Bold="True"></asp:Label>
                     </td>
                </tr>
                <tr>
                    <td valign="top" style="height:1%;">
                        <div id="contentTopRightDiv" style="width:90%;height:500px; overflow-y:scroll;border:ridge 5px;font-size:10pt;" >
                            <asp:GridView ID="Grade" runat="server" CellPadding="0" Width="78%" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" Font-Names="verdana" Font-Size="9px"  AutoGenerateColumns="False" ForeColor="Black" GridLines="Vertical" AllowSorting="True" OnRowDataBound="Grade_RowDataBound" OnSorting="Grade_Sorting" OnRowCommand="Grade_RowCommand" >
