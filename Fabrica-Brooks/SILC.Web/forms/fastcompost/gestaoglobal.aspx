<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gestaoglobal.aspx.cs" Inherits="SILC.Web.forms.fastcompost.gestaoglobal" %>
...
<head runat="server">
    ...
    <title></title>
     <style>
        ...
        .divcentral
        {
            background-image: url('sedegestaoglobal.jpg'); width: 1000px; height:339px;margin:auto;
        }
        .divmenuservicos
        {
        ...
        .divinstalacoes
        {
            background-image: url('gestaoglobal2.jpg'); width: 1000px; height:608px;margin:auto;
        }
        .login 
        {
            width: 360px;
