<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="assessoria.aspx.cs" Inherits="SILC.Web.forms.fastcompost.assessoria" %>
...
<head runat="server">
    ...
    <title></title>
     <style>
        ...
        .divcentral
        {
            background-image: url('sedeassessoria.jpg'); width: 1000px; height:332px;margin:auto;
        }
        .divmenuservicos
        {
        ...
        .divinstalacoes
        {
            background-image: url('assessoria2.jpg'); width: 1000px; height:349px;margin:auto;
        }
        .login 
        {
            width: 360px;
