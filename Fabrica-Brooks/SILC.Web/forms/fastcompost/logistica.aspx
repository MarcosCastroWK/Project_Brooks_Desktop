<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="logistica.aspx.cs" Inherits="SILC.Web.forms.fastcompost.Logistica" %>
...
<head runat="server">
    ...
    <title></title>
     <style>
        ...
        .divcentral
        {
            background-image: url('sedelogisticareversa.jpg'); width: 998px; height:335px;margin:auto;
        }
        .divmenuservicos
        {
        ...
        .divinstalacoes
        {
            background-image: url('logisticareversa2.jpg'); width: 998px; height:337px;margin:auto;
        }
        .login 
        {
            width: 360px;
