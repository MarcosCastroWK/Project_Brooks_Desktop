<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="destinacaofinal.aspx.cs" Inherits="SILC.Web.forms.fastcompost.destinacaofinal" %>
...
<head runat="server">
    ...
    <title></title>
     <style>
        ...
        .divcentral
        {
            background-image: url('sededestinacaofinal.jpg'); width: 998px; height:335px;margin:auto;
        }
        .divmenuservicos
        {
            background-image: url('menuservicos.jpg'); width: 998px; height:175px;margin:auto;
        }
        .divinstalacoes
        {
            background-image: url('destinacaofinal2.jpg'); width: 998px; height:332px;margin:auto;
        }
        .login 
        {
            width: 360px;
