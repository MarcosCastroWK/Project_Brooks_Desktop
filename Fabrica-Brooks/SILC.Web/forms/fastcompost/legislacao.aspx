<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="legislacao.aspx.cs" Inherits="SILC.Web.forms.fastcompost.legislacao" %>
...
<head runat="server">
    ...
    <title></title>
     <style>
        ...
        .divcentral
        {
            background-image: url('sedelegislacao.jpg'); width: 1000px; height:334px;margin:auto;
        }
        .divmenuservicos
        {
        ...
        .divinstalacoes
        {
            background-image: url('legislacao2.jpg'); width: 1000px; height:1435px;margin:auto;
        }
        .login 
        {
            width: 360px;
