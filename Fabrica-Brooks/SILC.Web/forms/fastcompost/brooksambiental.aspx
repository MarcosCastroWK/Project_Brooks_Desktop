<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="brooksambiental.aspx.cs" Inherits="SILC.Web.forms.fastcompost.brooksambiental" %>
...
<head runat="server">
    ...
    <title></title>
     <style>
        ...
        .divcentral
        {
            background-image: url('sedefoto2.jpg'); width: 1000px; height:334px;margin:auto;
        }
        .divmenuservicos
        {
        ...
        .divinstalacoes
        {
            background-image: url('instalacoes.jpg'); width: 1000px; height:1418px;margin:auto;
        }
        .login 
        {
            width: 360px;
    ...
    <form id="form1" runat="server">
        ...
        <div class="divcentral">
            <table cellspacing="0" cellpadding="0">
                <tr>
                    <td>
                        <a href="default.aspx"><asp:Image ID="Image5" runat="server" ImageUrl="~/forms/brooks/home.jpg" style="border:0px;" /></a>
                    </td>
                    <td style="position:relative; left:80px;">
                        <a href="brooksambiental.aspx"><img id="Image6" src="brooksambiental.jpg" style="border:0px;left:200px" /></a>
                    </td>
                    <td style="position:relative; left:158px;">
                        <a href="equipamentos.aspx"><img id="Img1" src="equipamentos.jpg" style="border:0px;left:200px" /></a>
                    </td>
                    <td style="position:relative; left:240px;">
                        <a href="legislacao.aspx"><img id="Img2" src="legislacao.jpg" style="border:0px;left:200px" /></a>
                    </td>
                    <td style="position:relative; left:312px;">
                        <a href="perguntasfrequentes.aspx"> <img id="Img3" src="perguntasfrequentes.jpg" style="border:0px;left:200px" /></a>
                    </td>
                    <td style="position:relative; left:384px;">
                        <a href="contato.aspx"><img id="Img4" src="contato.jpg" style="border:0px;left:200px" /></a>
                    </td>
                </tr>
            </table>
        </div>
