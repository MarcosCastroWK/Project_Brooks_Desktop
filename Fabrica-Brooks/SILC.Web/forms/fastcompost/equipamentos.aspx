<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="equipamentos.aspx.cs" Inherits="SILC.Web.forms.fastcompost.equipamentos" %>
...
<head runat="server">
    ...
    <title></title>
     <style>
        ...
        .divcentral
        {
            background-image: url('sedefoto3.jpg'); width: 1000px; height:334px;margin:auto;
        }
        .divmenuservicos
        {
        ...
        .divinstalacoes
        {
            background-image: url('equipamentos2.jpg'); width: 1000px; height:1900px;margin:auto;
        }
        .login 
        {
            width: 360px;
            ...
            <table cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td style="position:relative; left:150px;">
                        <a href="equipamentos.aspx"><img id="Img1" src="equipamentos3.jpg" style="border:0px;" /></a>
                    </td>
                    <td style="position:relative; left:230px;">
                        <a href="legislacao.aspx"><img id="Img2" src="legislacao.jpg" style="left:200px;border:0px;" /></a>
                    </td>
                    <td style="position:relative; left:304px;">
                        <a href="perguntasfrequentes.aspx"> <img id="Img3" src="perguntasfrequentes.jpg" style="left:200px;border:0px;" /></a>
                    </td>
                    <td style="position:relative; left:378px;">
