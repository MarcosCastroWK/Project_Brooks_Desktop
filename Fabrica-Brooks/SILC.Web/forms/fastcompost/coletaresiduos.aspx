<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="coletaresiduos.aspx.cs" Inherits="SILC.Web.forms.fastcompost.coletaresiduos" %>
...
<head runat="server">
    ...
    <title></title>
     <style>
        ...
        .divcentral
        {
            background-image: url('sedecoletaresiduos.jpg'); width: 1000px; height:333px;margin:auto;
        }
        .divmenuservicos
        {
        ...
        .divinstalacoes
        {
            background-image: url('coletaresiduos2.jpg'); width: 1000px; height:968px;margin:auto;
        }
        .login 
        {
            width: 360px;
