<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="USTE.aspx.cs" Inherits="SILC.Web.forms.fastcompost.USTE" %>
...
<head runat="server">
    ...
    <title></title>
     <style>
        ...
        .divcentral
        {
            background-image: url('sedeUSTE.jpg'); width: 1000px; height:338px;margin:auto;
        }
        .divmenuservicos
        {
        ...
        .divinstalacoes
        {
            background-image: url('USTE2.jpg'); width: 1000px; height:825px;margin:auto;
        }
        .login 
        {
            width: 360px;
