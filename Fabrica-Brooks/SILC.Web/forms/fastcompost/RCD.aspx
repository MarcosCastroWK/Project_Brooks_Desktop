<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RCD.aspx.cs" Inherits="SILC.Web.forms.fastcompost.RCD" %>
...
<head runat="server">
    ...
    <title></title>
     <style>
        ...
        .divcentral
        {
            background-image: url('sedeRCD.jpg'); width: 1000px; height:335px;margin:auto;
        }
        .divmenuservicos
        {
        ...
        .divinstalacoes
        {
            background-image: url('RCD2.jpg'); width: 1000px; height:548px;margin:auto;
        }
        .login 
        {
            width: 360px;
