<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="SILC.Web.forms.fastcompost.Default" %>
...
<head runat="server">
    ...
    <title></title>
     <style>
        ...
        .divcentral
        {
            background-image: url('sede.jpg'); width: 1000px; height:334px;margin:auto;
        }
        .divmenuservicos
        {
            ...
            <table cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td style="position:relative; left:384px;">
                        <a href="contato.aspx"><img id="Img4" src="contato.jpg" style="border:0px;" /></a>
                    </td>
                </tr>
            </table>
        </div>
