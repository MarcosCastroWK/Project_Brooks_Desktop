<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DTR.aspx.cs" Inherits="SILC.Web.forms.fastcompost.DTR" %>
...
<head runat="server">
    ...
    <title></title>
     <style>
        ...
        .divcentral
        {
            background-image: url('sedeDTR.jpg'); width: 998px; height:336px;margin:auto;
        }
        .divmenuservicos
        {
        ...
        .divinstalacoes
        {
            background-image: url('DTR2.jpg'); width: 998px; height:550px;margin:auto;
        }
        .login 
        {
            width: 360px;
