<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="coletaseletiva.aspx.cs" Inherits="SILC.Web.forms.fastcompost.coletaseletiva" %>
...
<head runat="server">
    ...
    <title></title>
     <style>
        ...
        .divcentral
        {
            background-image: url('sedecoletaseletiva.jpg'); width: 1000px; height:332px;margin:auto;
        }
        .divmenuservicos
        {
        ...
        .divinstalacoes
        {
            background-image: url('coletaseletiva2.jpg'); width: 1000px; height:562px;margin:auto;
        }
        .login 
        {
            width: 360px;
