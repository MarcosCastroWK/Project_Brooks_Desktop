<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RSS.aspx.cs" Inherits="SILC.Web.forms.fastcompost.RSS" %>
...
<head runat="server">
    ...
    <title></title>
     <style>
        ...
        .divcentral
        {
            background-image: url('sedeRSS.jpg'); width: 1000px; height:339px;margin:auto;
        }
        .divmenuservicos
        {
        ...
        .divinstalacoes
        {
            background-image: url('RSS2.jpg'); width: 1000px; height:554px;margin:auto;
        }
        .login 
        {
            width: 360px;
