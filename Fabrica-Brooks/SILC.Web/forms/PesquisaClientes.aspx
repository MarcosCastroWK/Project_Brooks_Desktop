<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PesquisaClientes.aspx.cs" Inherits="SILC.Web.forms.PesquisaClientes" %>
            ...
            <table class="form2">
                ...
                <tr>
                    <td id="dadosCab" valign="top" style="height:1%; font-size:9pt;">
                        <asp:Label ID="lblTitulo" runat="server" Text="&nbsp;Consulta&nbsp;Clientes" CssClass="titulo2" Font-Bold="True"></asp:Label>
                     </td>
                </tr>
                <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlFiltro" runat="server" Width="200px">
                                    <asp:ListItem Value="NomeFantasia"></asp:ListItem>
                                    <asp:ListItem Value="Nome"></asp:ListItem>
                                    <asp:ListItem Value="Codigo">C�digo</asp:ListItem>
                                </asp:DropDownList>
                            </td>
                            <td>
                            ...
                            <td class="auto-style1">
                                <asp:Button ID="btnOk" runat="server" Text="Ok" OnClick="btnOk_Click" OnClientClick="DesabilitaOperacoes(this.id, '', '', 'Pesquisa clientes');" />
                            </td>
                        </tr>
                    </table>
