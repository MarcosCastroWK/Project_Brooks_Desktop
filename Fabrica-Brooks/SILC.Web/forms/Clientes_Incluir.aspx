<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Clientes_Incluir.aspx.cs" Inherits="SILC.Web.forms.webClientesIncluir" %>
        ...
        <table border="0" class="form2">
            ...
            <tr>
                <td id="dadosCab" valign="top" style="height:1%; font-size:9pt;">
                    <asp:Label ID="lblTitulo" runat="server" Text="Inclusão&amp;nbsp;de&amp;nbsp;Clientes" Font-Bold="True" CssClass="titulo3"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td>
                    ...
                    <asp:Menu
                        ...
                        CssClass="tabs"
                        Runat="server" StaticSubMenuIndent="10px" BackColor="#B5C7DE" DynamicHorizontalOffset="2" Font-Names="Verdana" Font-Size="10px" ForeColor="black" OnMenuItemClick="Menu1_MenuItemClick1">
                            ...
                            <table style="width:400px">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center;">
                                        <asp:Button ID="Button1" runat="server" CommandName="Salvar" Font-Size="10pt" OnClick="Salvar_Click" TabIndex="2" Text="Ok" />
                                    </td>
                                    <td>
                                        <div style="width:160px">
                                        </div>
