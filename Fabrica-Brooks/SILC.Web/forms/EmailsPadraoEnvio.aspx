<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmailsPadraoEnvio.aspx.cs" Inherits="SILC.Web.forms.EmailsPadraoEnvio" %>
            ...
            <table class="form2">
                ...
                <tr>
                    <td id="dadosCab" valign="top" style="height:1%; font-size:9pt;">
                        <asp:Label ID="lblTitulo" runat="server" Text="&nbsp;Emails Padrão para Envio" Font-Bold="True" CssClass="titulo2"></asp:Label>
                     </td>
                </tr>
                <tr>
                    <td valign="top" style="height:1%;">
                        <div id="contentTopRightDiv" style="width:98%;height:300px; overflow-y:scroll;border:ridge 5px;font-size:10pt;" >
                            <asp:GridView ID="Grade" runat="server" CellPadding="3" Width="70%" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" Font-Names="verdana" Font-Size="9px" ClientIDMode="AutoID" OnRowCommand="Grade_RowCommand" AutoGenerateColumns="False" OnRowDataBound="Grade_RowDataBound" ForeColor="Black" GridLines="Vertical" AllowSorting="True" OnSorting="Grade_Sorting" Font-Bold="False" >
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="email" HeaderText="e-mail Padrão para Envio" SortExpression="email">
                                    <ItemStyle CssClass="padItemGrade" HorizontalAlign="Left" Width="500px" />
                                    </asp:BoundField>
                                </Columns>
                        ...
                        <table style="width:300px">
                            <tr>
                                ...
                                <td class="auto-style11">
                                    <asp:TextBox ID="txtDescricao" runat="server" Width="209px" ></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="auto-style10">
                                    <asp:Label ID="lblNomePref" CssClass="LetrasLabel" runat="server" Font-Bold="False" Width="100px" >&nbsp;e-mail</asp:Label>
                                </td>
                                <td class="auto-style11">
                                    <asp:TextBox ID="txtemail" runat="server" Width="481px" ></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="auto-style17">
                                    <asp:Label ID="lblSenha" CssClass="LetrasLabel" runat="server" Font-Bold="False" >&nbsp;Senha</asp:Label>
                                </td>
                                <td class="auto-style18">
                                    <asp:TextBox ID="txtSenha" runat="server" Width="239px" ></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="auto-style17">
                                    <asp:Label ID="lblSenha0" CssClass="LetrasLabel" runat="server" Font-Bold="False" >&nbsp;Confirmar Senha</asp:Label>
                                </td>
                                <td class="auto-style18">
                                    <asp:TextBox ID="txtConfirmarSenha" runat="server" Width="239px" ></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
