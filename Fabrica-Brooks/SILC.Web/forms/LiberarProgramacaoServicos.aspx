<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LiberarProgramacaoServicos.aspx.cs" Inherits="SILC.Web.forms.LiberarProgramacaoServicos" %>
               ...
               <tr>
                   <td align="center">
                       <table style="text-align:center; width:30%; height:40%;border:ridge 8px ActiveBorder;">
                            <tr>
                                <td id="dadosCab" valign="center" style="text-align:center; font-size:9pt;height:120px;">
                                    <asp:Label ID="lblTitulo" runat="server" Text="&nbsp;Liberar Programação de Serviços" Font-Bold="True" Font-Names="Arial"></asp:Label>
                                 </td>
                            </tr>
                            <tr>
                                <td style="text-align:center;height:20px">
                                    <asp:Button runat="server" Font-Size="10pt" CommandName="Salvar" Text="Liberar" ID="Salvar" OnClick="Salvar_Click" />
