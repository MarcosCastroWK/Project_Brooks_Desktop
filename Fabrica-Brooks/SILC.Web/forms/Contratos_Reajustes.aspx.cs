    ...
    public partial class Contratos_Reajustes : System.Web.UI.Page
    {
        ...
        private void TiraSelecionadoReajustes()
        {
            ...
            for (int i = 0; i < GradeReajustes.Rows.Count; i++)
            {
                ...
                DATA _datDataReajuste = (DATA)gvr.Cells[3].FindControl("datDataReajuste");
                DropDownList _ddlTipoNegociacao = (DropDownList)gvr.Cells[4].FindControl("ddlTipoNegociacao");
                MOEDA _moePercentualContrato = (MOEDA)gvr.Cells[5].FindControl("moePercentualContrato");
                MOEDA _moePercentualUnitarios = (MOEDA)gvr.Cells[6].FindControl("moePercentualUnitarios");
                MOEDA _moeValorContrato = (MOEDA)gvr.Cells[7].FindControl("moeValorContrato");
                INTEIRO7 _intNumeroContrato = (INTEIRO7)gvr.Cells[8].FindControl("intNumeroContrato");
                DropDownList _ddlSituacao = (DropDownList)gvr.Cells[9].FindControl("ddlSituacao");
                DATA _datProximoReajuste = (DATA)gvr.Cells[11].FindControl("ProximoReajuste");
                    ...
                    if (Grade.Rows.Count - 1 >= Convert.ToInt32(e.CommandArgument))
                    {
                        ...
                        if (GradeReajustes.Rows.Count > 0)
                        {
                            try
                            {
                                ...
                                oContratoResiduos.DataReajuste = ((DATA)GradeReajustes.Rows[1].Cells[3].FindControl("datDataReajuste")).Data;
        ...
        private void FazOk(bool bRefreshGradeResiduos)
        {
            ...
            if (_dt.Rows.Count > 0)
            {
                ...
                DATA _datDataReajuste;
                try
                {
                    _datDataReajuste = (DATA)GradeReajustes.Rows[1].Cells[3].FindControl("datDataReajuste");
        ...
        private void GradeResiduosContratados(GridView pGrade, int pLinha)
        {
            if (bMostraResiduos)
            {
                ...
                {
                    oContratoResiduos.DataReajuste = ((DATA)pGrade.Rows[pLinha].Cells[3].FindControl("datDataReajuste")).Data;
        ...
        protected void GradeReajustes_RowCommand(object sender, GridViewCommandEventArgs e)
        {
                ...
                e.CommandArgument.ToString() != "Observacao" && e.CommandArgument.ToString() != "Sequencial")
            {
                ...
                if (e.CommandArgument.ToString() != "")
                {
                    ...
                    hifDataReajuste.Value = ((DATA)oGrade.Rows[Convert.ToInt32(e.CommandArgument)].Cells[3].FindControl("datDataReajuste")).Data;
                    if (bSalvarReajuste)
                    {
        ...
        protected void GradeReajustes_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowIndex >= 0)
            {
                ...
                MOEDA _moePercentualContrato = (MOEDA)e.Row.Cells[5].FindControl("moePercentualContrato");
                MOEDA _moePercentualUnitarios = (MOEDA)e.Row.Cells[6].FindControl("moePercentualUnitarios");
                INTEIRO7 _intNumeroContrato = (INTEIRO7)e.Row.Cells[8].FindControl("intNumeroContrato");
                DropDownList _ddlSituacao = (DropDownList)e.Row.Cells[9].FindControl("ddlSituacao");
                DATA _datDataReajuste = new DATA();
                MOEDA _moeValorContrato = new MOEDA();
                DATA _datProximoReajuste = new DATA();
                ...
                if (GradeReajustes.Rows.Count > 0)
                {
                    _datDataReajuste = (DATA)GradeReajustes.Rows[0].Cells[3].FindControl("datDataReajuste");
                    _moeValorContrato = (MOEDA)GradeReajustes.Rows[0].Cells[7].FindControl("moeValorContrato");
                    _datProximoReajuste = (DATA)GradeReajustes.Rows[0].Cells[11].FindControl("ProximoReajuste");
                ...
                {
                    _datDataReajuste = (DATA)e.Row.Cells[3].FindControl("datDataReajuste");
                    _moeValorContrato = (MOEDA)e.Row.Cells[7].FindControl("moeValorContrato");
                    _datProximoReajuste = (DATA)e.Row.Cells[11].FindControl("ProximoReajuste");
                    _txtObservacao = (TextBox)GradeReajustes.Rows[0].Cells[12].FindControl("txtObservacao");
                    e.Row.Cells[2].Text = "";
        ...
        protected void Salvar_Residuos_ReajusteNovo(clsContratosReajustes pReajuste)
        {
            if (geral.IsNumeric(hifCodigo.Value) && hifCodigo.Value != "" && hifValorContrato.Value != "")
            {
                ...
                if (oReajustesDados.Inserir(pReajuste))
                {
                    ...
                    DATA _dataProximoReajuste = new DATA();
                    if (pReajuste.TipoNegociacao.IndexOf("REAJUSTE") > -1)
                    {
                        _dataProximoReajuste = (DATA)GradeReajustes.Rows[0].Cells[11].FindControl("ProximoReajuste");
                    ...
                    if (GradeReajustes.Rows.Count > 0)
                    {
                        GradeResiduos.DataSource = "";
                        GradeResiduos.DataBind();
                        DATA _dataReajusteAnterior = new DATA();
                        DATA _dataReajuste = new DATA();
                        MOEDA _moeNovoValorContrato = new MOEDA();
                        MOEDA _moePercentualContrato = (MOEDA)GradeReajustes.Rows[0].Cells[5].FindControl("moePercentualContrato");
                        MOEDA _moePercentualUnitarios = (MOEDA)GradeReajustes.Rows[0].Cells[6].FindControl("moePercentualUnitarios");
                        if (GradeReajustes.Rows.Count > 1)
                        {
                            _dataReajusteAnterior = (DATA)GradeReajustes.Rows[1].Cells[3].FindControl("datDataReajuste");
                            _dataReajuste = (DATA)GradeReajustes.Rows[0].Cells[3].FindControl("datDataReajuste");
                            _moeNovoValorContrato = (MOEDA)GradeReajustes.Rows[0].Cells[7].FindControl("moeValorContrato");
        ...
        protected void GradeResiduos_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowIndex >= 0)
            {
                ...
                MOEDA _moeFranquiaCobrancaMensal = (MOEDA)e.Row.Cells[10].FindControl("moeFranquiaCobrancaMensal");
                ...
                //MOEDA _moeValorContratoCobrancaMensal = (MOEDA)e.Row.Cells[14].FindControl("moeValorContratoCobrancaMensal");
                MOEDA _moeValorExcedenteCobrancaMensal = (MOEDA)e.Row.Cells[15].FindControl("moeValorExcedenteCobrancaMensal");
                DropDownList _ddlexpressao1CobrancaPeso = (DropDownList)e.Row.Cells[16].FindControl("ddlexpressao1CobrancaPeso");
                MOEDA _moeValorUnitario = (MOEDA)e.Row.Cells[17].FindControl("moeValorUnitario");
                ...
                MOEDA _moeFranquiaCobrancaPeso = (MOEDA)e.Row.Cells[20].FindControl("moeFranquiaCobrancaPeso");
        ...
        private void ExcluirReajuste(int pLinhaExcluir)
        {
            if (pLinhaExcluir == 1)
            {
                if (hifCodigo.Value != "" && geral.IsNumeric(hifCodigo.Value) && GradeReajustes.Rows[1].Cells[10].Text != "" && geral.IsNumeric(GradeReajustes.Rows[1].Cells[10].Text))
                {
                    ...
                    hifDataReajuste.Value = ((DATA)GradeReajustes.Rows[2].Cells[3].FindControl("datDataReajuste")).Data;
                    hifValorContrato.Value = ((MOEDA)GradeReajustes.Rows[2].Cells[7].FindControl("moeValorContrato")).Valor;
                    int LinhaContrato = 0;
                    for (int i = 0; i < Grade.Rows.Count; i++)
                    {
                        ImageButton ibn = new ImageButton();
                    ...
                    if (_ddlTipoNegociacao.Text.IndexOf("REAJUSTE") > -1)
                        Grade.Rows[LinhaContrato].Cells[8].Text = ((DATA)GradeReajustes.Rows[1].Cells[3].FindControl("datDataReajuste")).Data;
                    else
                        Grade.Rows[LinhaContrato].Cells[8].Text = ((DATA)GradeReajustes.Rows[0].Cells[11].FindControl("ProximoReajuste")).Data;
                    if (hifCodigoCliente.Value != "" && geral.IsNumeric(hifCodigoCliente.Value))
                    {
                        ...
                        lblMensagemResiduos.Text = oContratoResiduosDados.Excluir(Convert.ToInt32(hifCodigo.Value), Convert.ToInt32(hifCodigoCliente.Value),
                                                                                  ((DATA)GradeReajustes.Rows[1].Cells[3].FindControl("datDataReajuste")).Data);
                    }
                    hifDataReajuste.Value = Grade.Rows[LinhaContrato].Cells[8].Text;
                    ClearGradeResiduos();
            ...
            try
            {
                foreach (GridViewRow gvr in GradeResiduos.Rows)
                {
                        ...
                        hifCodigoCliente.Value != "" && geral.IsNumeric(hifCodigoCliente.Value))
                    {
                        ...
                        oContratoResiduos.PeriodicidadeCobrancaMensal = ddlPeriodicidadeCobrancaMensal.Text;
                        //MOEDA moeValorContratoCobrancaMensal = (MOEDA)gvr.Cells[10].FindControl("moeValorContratoCobrancaMensal");
