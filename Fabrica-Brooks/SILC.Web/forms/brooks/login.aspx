<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="SILC.Web.forms.brooks.login" %>
...
<head runat="server">
    ...
    <title></title>
     <style>
        ...
        .divcentral
        {
            background-image: url('sedebrooks.jpg'); width: 74%; height:310px;margin-left:10%; 
        }
        .login 
        {
            width: 42%;
...
<body class="body">
    <form id="form1" runat="server">
        <div class="cabecbrooks">
            <asp:Image ID="Image1" runat="server" ImageAlign="Middle" ImageUrl="~/Images/cabecbrooks.jpg" Width="100%" />
		</div>
        <div class="divcentral">
			...
			<table class="login">
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label2" runat="server" AssociatedControlID="Password" CssClass="LetrasLabel">Senha2</asp:Label>
                    </td>
                    <td>
        ...
        <div class="rodapebrooks">
            <asp:Image ID="Image2" runat="server" ImageAlign="Middle" ImageUrl="~/Images/rodapebrooks.jpg" Width="100%" />
        </div>
    </form>
</body>
</html>
