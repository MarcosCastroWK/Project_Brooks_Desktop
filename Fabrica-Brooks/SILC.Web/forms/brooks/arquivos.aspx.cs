            ...
            if (e.Row.RowIndex >= 0)
            {
                ...
                else
                {
                    if (rdbAlvara.Checked || rdbCERTISO9001.Checked || rdbLAO.Checked || rdbCTFIBAMA.Checked)
                        ...
                        e.Row.Cells[0].Text = "<a style='text-decoration:none;color:black;' target='_blank' href='../../dados/" + oUsuario.Nome.Substring(0, 3) + "/" + oUsuario.Nome.Substring(3, 6) + "/" + e.Row.Cells[0].Text + "'>" + e.Row.Cells[0].Text.Replace(".pdf", "") + "</a>";
                }
            }
        }
    }
