<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="loginaplicativo.aspx.cs" Inherits="SILC.Web.forms.brooks.loginaplicativo" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="divcentral">
            <table id="table1" class="login">
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label2" runat="server" AssociatedControlID="Password" CssClass="LetrasLabel">Senha3</asp:Label>
                    </td>
                    <td>
