<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RelatorioContaineres.aspx.cs" Inherits="SILC.Web.Relatorios.Relatorios_RelatorioContaineres" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="Operacoes">
            ...
            <asp:Label ID="lblTitulo" runat="server" CssClass="titulo2" Text="Relatório de Containeres"></asp:Label>
    
            <asp:Panel ID="panTipo" runat="server" GroupingText="Tipo" CssClass="titulo2" Width="300px" BackColor="White">
                <asp:RadioButton ID="rdbLocadas" runat="server" Text="Locados" Checked="True" CssClass="LetrasLabel"  onclick="TiraLocadas();" OnCheckedChanged="rdbLocadas_CheckedChanged" />
                <asp:RadioButton ID="rdbDisponiveis" runat="server" Text="Disponiveis" CssClass="LetrasLabel"  onclick="TiraDisponiveis();" OnCheckedChanged="rdbDisponiveis_CheckedChanged" />
            </asp:Panel>
            <asp:Panel ID="panOrdenacao" runat="server" GroupingText="Ordenação" CssClass="titulo2" Width="300px" BackColor="White">
                <asp:RadioButton ID="rdbDataLocacao" runat="server" Text="Data Locação" Checked="True" CssClass="LetrasLabel" onclick="TiraDataLocacao();" />
                <asp:RadioButton ID="rdbNumeroCaixa" runat="server" Text="Nº Container" CssClass="LetrasLabel" onclick="TiraNumeroCaixa();" />
                <asp:RadioButton ID="rdbNomeFantasia" runat="server" Text="Nome Fantasia" CssClass="LetrasLabel" onclick="TiraNomeFantasia();" />
            </asp:Panel>
            <br />
        ...
        <div id="divImprimir">
            <asp:Panel ID="Panel1" runat="server">
                <asp:Label ID="lblTitulo0" runat="server" BackColor="White" CssClass="titulo2" Text="Relatório de Containeres"></asp:Label>
                <br />
                <br />
                <asp:GridView ID="Grade" runat="server" PageSize="45" Width="924px" CssClass="LetrasLabel" OnRowDataBound="Grade_RowDataBound" CellPadding="4" ForeColor="Black" GridLines="Horizontal" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px">
                ...
                <br />
                <asp:Label ID="lblTotalContaineres" runat="server" CssClass="LetrasLabel" Text="Total containeres" Font-Bold="true"></asp:Label>
            </asp:Panel>
        </div>
    </form>
</body>
