<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RelatorioDeClientesBloqueados.aspx.cs" Inherits="SILC.Web.Relatorios.Relatorios_RelatorioDeClientesBloqueados" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="Operacoes">
            ...
            <asp:Label ID="lblTitulo" runat="server" CssClass="titulo2" Text="Relatório de Clientes Bloqueados"></asp:Label>
            ...
            <table>
                <tr>
                    <td>
                        <asp:Button ID="btnOk" runat="server" Text="Ok" OnClick="btnImprimir_Click" OnClientClick="DesabilitaOperacoes(this.id, '', '', 'Relatório de Clientes Bloqueados');" />
                    </td>
                    <td>
        ...
        <asp:Panel ID="Panel1" runat="server" Width="1220px">
