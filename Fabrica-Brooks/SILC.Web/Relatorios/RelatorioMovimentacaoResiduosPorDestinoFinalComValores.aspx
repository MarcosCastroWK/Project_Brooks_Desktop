<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RelatorioMovimentacaoResiduosPorDestinoFinalComValores.aspx.cs" Inherits="SILC.Web.Relatorios.RelatorioMovimentacaoResiduosPorDestinoFinalComValores" %>
...
<head runat="server">
    ...
    <script>
        ...
        function AbrePesquisaDestinoFinal() {
            ...
            {
                document.getElementById("<%=btnProcurar.ClientID%>").click();
                location = '../forms/PesquisaDestinoFinal.aspx?explorer=../Relatorios/RelatorioMovimentacaoResiduosPorDestinoFinalComValores.aspx';
            }
        }
        function Imprime()
        {
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div id="Operacoes">
            ...
            <asp:Label ID="lblTitulo" runat="server" CssClass="titulo2" Text="Relatório de Movimentação de Resíduos por Destino Final Com Valores"></asp:Label>
                ...
                <tr>                
                    <td colspan="8">
                        <table>
                            <tr>
                                <td>
                                    <asp:Button ID="btnOk" runat="server" Text="Ok" OnClick="btnOk_Click" OnClientClick="DesabilitaOperacoes(this.id, 'Data1_txtData', 'Data2_txtData', 'Relatório de Movimentação de Resíduos por Destino Final Com Valores');" />
                                </td>
                                <td>
        ...
        <div id="divImprimir">
            <asp:Panel ID="Panel1" runat="server" BorderWidth="1px" Width="1062px"></asp:Panel>
        </div>
