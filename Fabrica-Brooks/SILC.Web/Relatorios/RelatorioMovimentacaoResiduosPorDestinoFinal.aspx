<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RelatorioMovimentacaoResiduosPorDestinoFinal.aspx.cs" Inherits="SILC.Web.Relatorios.RelatorioMovimentacaoResiduosPorDestinoFinal" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="Operacoes">
            ...
            <asp:Label ID="lblTitulo" runat="server" CssClass="titulo2" Text="Relatório de Movimentação de Resíduos por Destino Final"></asp:Label>
            ...
            <table>
                <tr>
                    ...
                    <td>
                        <asp:CheckBox ID="chkMostrarCDFe" runat="server" CssClass="LetrasLabel" Checked="true" Text="Mostrar CDFe" onclick="NaoChecados();" />
                        <br />
                ...
                <tr>
                    <td colspan="8">
                        <table>
                            <tr>
                                <td>
                                    <asp:Button ID="btnOk" runat="server" Text="Ok" OnClick="btnOk_Click" OnClientClick="DesabilitaOperacoes(this.id, 'Data1_txtData', 'Data2_txtData', 'Relatório de Movimentação de Resíduos por Destino Final');" />
                                </td>
                                <td>
                    ...
                    <td>
                        <table style="padding: 0;word-spacing:0; border: 1px solid;">
                            ...
                            <tr>
                                <td>
                                    <asp:CheckBox ID="chkIBAMA" runat="server" CssClass="LetrasLabel" Text="Código IBAMA" onclick="DischecarDivergentes(this.id);" Enabled="False" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:CheckBox ID="chkPlacas" runat="server" CssClass="LetrasLabel" Text="Placas" onclick="DischecarDivergentes(this.id);" Enabled="False" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:CheckBox ID="chkCNPJ" runat="server" CssClass="LetrasLabel" Text="CNPJ" onclick="DischecarDivergentes(this.id);" Enabled="False" />
                                </td>
                            </tr>
                        </table>
                    </td>
