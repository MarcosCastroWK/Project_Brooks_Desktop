	...
	public class clsContratosDados
	{
        ...
        private clsContratos AtribuirDados(clsContratos pContratos, int CodigoCliente)
        {
            if (l_ds.Tables.Count > 0)
            {
                ...
                if (l_dt.Rows.Count > 0)
                {
                    ...
                    if (l_dt.Rows[0]["Limitar"].ToString() != "")
                    {
                        pContratos.LimitarFranquia = Convert.ToInt32(l_dt.Rows[0]["LimitarFranquia"]);
                    }
        ...
        public clsContratos PegaDados(clsContratos pContratos, int pCodigo, int pCodigoCliente)
        {
            try
            {
                ...
                s = s + "       Observacao, c.Nome, c.NomeFantasia, AniversarioReajuste, DataRegistro, MotivoRescisao, AvisarDiasAntes, LimitarFranquia, C.CNPJ_CPF \n";
        ...
        public string Inserir(clsContratos pContratos, int pCodigo = 0)
        {
            try
            {
                ...
                s = s + "   NumeroCaixasLocadas, DataInicio, DataReajuste, DataRecisao, IndiceReajuste, SituacaoRecisao, \n";
                s = s + "   AniversarioReajuste, DataRegistro, MotivoRescisao, AvisarDiasAntes, Observacao, LimitarFranquia, \n";
                s = s + ") \n";
                s = s + "values \n";
                s = s + "( \n";
                if (pCodigo == 722)
                ...
                s = s + pContratos.LimitarFranquia.ToString();
                s = s + ")"; 
                ConectaBanco();
        ...
        public string Alterar(clsContratos pContratos, int pCodigo, int pCodigoCliente = 0)
        {
            ...
            try
            {
                ...
                s = s + "    LimitarFranquia = " + pContratos.LimitarFranquia.ToString() + " \n";
