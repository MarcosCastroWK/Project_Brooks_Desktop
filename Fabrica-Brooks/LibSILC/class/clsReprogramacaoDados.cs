...
namespace LibSILC
{
	public class clsReprogramacaoDados
	{
        ...
        public string GetDataReprogramacao(string pAnoMesDia, int pCodigoCliente, string pCodigoResiduo, string pHora)
        {
            try
            {
                oDB.ConectaMySql();
                s = "";
                s = s + "select DataProgramada ";
                s = s + "from   ReprogramacaoServicos ";
                s = s + "where  AnoMesDia      = " + pAnoMesDia + " \n";
                s = s + "and    CodigoCliente  = " + pCodigoCliente + " \n";
                s = s + "and    CodigoResiduo  = " + pCodigoResiduo + " \n";
                s = s + "and    Hora           ='" + pHora + "' \n";
                s = s + "and    StatusCor      ='8427929' \n";
                FillDataSet();
                if (l_dt.Rows.Count > 0)
