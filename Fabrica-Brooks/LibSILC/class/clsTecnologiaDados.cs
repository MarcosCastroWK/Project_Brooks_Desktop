...
namespace LibSILC
{
    public class clsTecnologiaDados
    {
        ...
        public clsTecnologia PegaDados(clsTecnologia pTecnologia, int pCodigo)
        {
            try
            {
                ConectaBanco();
                ...
                if (l_ds.Tables.Count > 0)
                {
                    ...
                    if (l_dt.Rows[0]["Codigo"].ToString() != "")
                        pTecnologia.Codigo = Convert.ToInt32(l_dt.Rows[0]["Codigo"]);
                    pTecnologia.Descricao = l_dt.Rows[0]["Descricao"].ToString();
                }
                return pTecnologia;
            }
            catch (Exception ex)
            {
                return new clsTecnologia();
            }
            finally
            {
                DesconectaBanco();
        ...
        public DataTable PegaDados(clsTecnologia pTecnologia, int pCodigo, bool pUltimoRegistro)
        {
            try
            {
                ConectaBanco();
        ...
        public void Inserir(clsTecnologia pTecnologia, int pCodigo = 0)
        {
            try
            {
                s = "";
                s = s + "insert into Tecnologia \n";
                s = s + "( \n";
                if (pCodigo > 0)
                    s = s + "  Codigo, \n";
                s = s + "  Descricao \n"; 
        ...
        public string Alterar(clsTecnologia pTecnologia, int pCodigo)
        {
            ConectaBanco();
            MySqlCommand command = oDB.MySqlConnect.CreateCommand();
            MySqlTransaction transaction;
            ...
            {
                s = "";
                s = s + "update Tecnologia \n";
                s = s + "set Descricao = '" + pTecnologia.Descricao + "' \n";
