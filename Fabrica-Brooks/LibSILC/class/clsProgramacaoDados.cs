	...
	public class clsProgramacaoDados
	{
            ...
            try
            {
                ...
                if (l_ds.Tables.Count > 0)
                {
                    ...
                    if (l_dt.Rows.Count > 0)
                    {
                        ...
                        pProgramacao.ServicoExecutado = l_dt.Rows[0]["HoraProgramada"].ToString();
                        ...
                        if (l_dt.Rows[0]["DataProgramada"].ToString() != "")
                           pProgramacao.DataProgramada =  Convert.ToDateTime(l_dt.Rows[0]["DataProgramada"]).ToString("dd/MM/yyyy");
                    }
                }
        ...
        public DataTable PegaDados(int pAnoMesDia, int pQuadro, bool pNaoMostrarFechados, string pOrdem = "")
        {
            try
            {
                ...
                s = s + "       p.Unidade2, p.CorObservacao, p.Origem, p.NumeroMTRe, \n";
        ...
        public bool ExisteProgramacaoFechada(string pHora, string pCodigoCliente, string pCodigoResiduo, string pSolicitante)
        {
            bool bRet = false;
            try
            {
                ...
                s = s + "and    Solicitante    = '" + pSolicitante + "' \n";
        ...
        public bool ExisteReprogramacaoFechada(string pCodigoCliente, string pCodigoResiduo, string pExecutarServico, string pAnoMesDiaDoFuturo)
        {
            bool bRet = false;
            try
            {
                ...
                s = s + "select Sequencial \n";
                s = s + "from   ProgramacaoDiariaServicos \n";
                s = s + "where  StatusCor       = '" + geral.RetornaCodigoCor("Azul") + "' \n";
                s = s + "and    CodigoCliente   = "  + pCodigoCliente + " \n";
                s = s + "and    CodigoResiduo   = "  + pCodigoResiduo + " \n ";
                s = s + "and    ExecutarServico = '" + pExecutarServico + "' \n";
                s = s + "where  AnoMesDia       =  " + pAnoMesDiaDoFuturo + " \n";
                s = s + "limit 1 \n";
                FillDataSet();
                if (l_dt.Rows.Count > 0)
                    bRet = true;
