...
namespace LibSILC
{
    public class clsEnderecosHistoricoDados
    {
        ...
        public clsEnderecosHistoricoCadastro PegaDados(clsEnderecosHistoricoCadastro pEnderecos, int pCodigoHistoricoCliente, int pTipoEndereco, int pTipoCadastro)
        {
            try
            {
                ConectaBanco();
            ...
            {
                return new clsEnderecosHistoricoCadastro();
            }
            finally
            {
                DesconectaBanco();
        ...
        public int RetornaCodigoHistorico(int pCodigoHistoricoCliente, int pTipoEndereco, int pTipoCadastro)
        {
            int _retCodigo = 0;
            try
            {
        ...
        public string DadoExiste(int pCodigoCliente, int pTipoCadastro, int pTipoEndereco, int pCodigoClienteHistorico)
        {
            string sRet = "";
            try
            {
                ...
                s = s + "and    TipoCadastro = " + pTipoCadastro + " \n";
                s = s + "and    TipoEndereco = " + pTipoEndereco + " \n";
                s = s + "and    CodigoClienteHistorico = " + pCodigoClienteHistorico + " \n";
                FillDataSet();
        ...
        public void Inserir(clsEnderecosHistoricoCadastro pEnderecos, int pCodigoCliente, int pTipoCadastro, int pTipoEndereco, int pCodigoHistoricoCliente)
        {
            try
            {
                s = "";
                s = s + "insert into EnderecosHistorico \n";
                s = s + "( \n";
                s = s + "        TipoCadastro, TipoEndereco, endereco, Numero, Bairro, \n";
                s = s + "        CEP, CodigoMunicipio, DDD1, Fone1, DDD2, Fone2, DDD3, Fone3, \n";
                s = s + "        DDDF, Fax, email, Contato, InstrucoesFat, Complemento, CargoContato, CodigoCliente, CodigoClienteHistorico \n";
                s = s + ") \n";
                s = s + "values \n";
                s = s + "( \n";
                ...
                s = s + " " + pCodigoHistoricoCliente.ToString() + " \n";
                s = s + ")";
                ConectaBanco();
        ...
        public string Alterar(clsEnderecosHistoricoCadastro pEnderecos, int pCodigoCliente, int pTipoCadastro, int pTipoEndereco, int pCodigoHistoricoCliente)
        {
            string sRet = "";
            ConectaBanco();
            MySqlCommand command = oDB.MySqlConnect.CreateCommand();
            ...
            try
            {
                ...
                s = s + "where CodigoClinete   = " + pCodigoCliente.ToString() + " \n";
                s = s + "and   TipoCadastro = " + pTipoCadastro.ToString() + " \n";
                s = s + "and   TipoEndereco = " + pTipoEndereco.ToString() + " \n";
                s = s + "and   CodigoHistoricoCliente = " + pCodigoHistoricoCliente.ToString() + " \n";
                command.CommandText = s;
                command.ExecuteNonQuery();
                transaction.Commit();
                sRet = string.Empty;
        ...
        public string Excluir(int pCodigo, string pTipoCadastro, string pTipoEndereco)
        {
            ...
            try
            {
                ...
                if (pCodigo > 0)
                {
                    s = s + "delete from EnderecosHistorico \n";
