...
namespace LibSILC
{
    public class clsEstadoFisicoDados
    {
        ...
        public clsEstadoFisico PegaDados(clsEstadoFisico pEstadoFisico, int pCodigo)
        {
            try
            {
                ConectaBanco();
                ...
                if (l_ds.Tables.Count > 0)
                {
                    ...
                    if (l_dt.Rows[0]["Codigo"].ToString() != "")
                        pEstadoFisico.Codigo = Convert.ToInt32(l_dt.Rows[0]["Codigo"]);
                    pEstadoFisico.Descricao = l_dt.Rows[0]["Descricao"].ToString();
                }
                return pEstadoFisico;
            }
            catch (Exception ex)
            {
                return new clsEstadoFisico();
            }
            finally
            {
                DesconectaBanco();
        ...
        public DataTable PegaDados(clsEstadoFisico pEstadoFisico, int pCodigo, bool pUltimoRegistro)
        {
            try
            {
                ConectaBanco();
        ...
        public void Inserir(clsEstadoFisico pEstadoFisico, int pCodigo = 0)
        {
            try
            {
                s = "";
                s = s + "insert into EstadoFisico \n";
                s = s + "( \n";
                if (pCodigo > 0)
                    s = s + "  Codigo, \n";
                s = s + "  Descricao \n"; 
        ...
        public string Alterar(clsEstadoFisico pEstadoFisico, int pCodigo)
        {
            ConectaBanco();
            MySqlCommand command = oDB.MySqlConnect.CreateCommand();
            MySqlTransaction transaction;
            ...
            {
                s = "";
                s = s + "update EstadoFisico \n";                
                s = s + "set   Descricao = '" + pEstadoFisico.Descricao + "' \n";
